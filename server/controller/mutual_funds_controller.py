...
def add_mutual_funds():
    try:
        ...
        MutualFundsRepo.add_new_stock(new_mf)
...
def update_mutual_funds():
    try:
        ...
        MutualFundsRepo.update_stock(mutual_funds=mutual_funds)
...
def get_returns(mf_id: int):
    try:
        mutual_funds_returns = MutualFundsRepo.get_stock_returns(mf_id)
...
def get_stock_performance():
    ...
    all_mutual_funds = MutualFundsRepo.get_all_stocks()
